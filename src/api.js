...
export const getArticles = (sortQry, topicQry) => {
  return raydditApi
    .get(`/articles`, { params: { topic: topicQry, sort_by: sortQry } })
    .then((res) => {
...
export const getTopics = () => {
  return raydditApi.get(`/topics`).then((res) => {
    return res.data.topics;
  });
};

export const getSingleArticle = (article_id) => {
  return raydditApi.get(`/articles/${article_id}`).then((res) => {
...
export const getComments = (article_id) => {
  return raydditApi.get(`/articles/${article_id}/comments`).then((res) => {
